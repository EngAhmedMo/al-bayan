...
<ul style="list-style-position: inside; padding-right: 16px; padding-left: 0; margin: 0;">
  ...
  <li>🧠 نظام ذكي لحفظ القرآن الكريم بخطط متعددة + خيارات مرنة للورد اليومي (صفحة كاملة، نصف صفحة، ربع صفحة) + ميزة الورد الإضافي والتراجع + اختبارات ذاتية + تتبع التقدم والإنجازات ومشاركة النتائج.</li>
...
<table>
  ...
  <tr>
    ...
    <td align="center">
      <a href="screenshots/11-widget.jpg"><img src="screenshots/11-widget.jpg" width="180" alt="ويدجت التاريخ الهجري"></a>
      <div>ويدجت التاريخ الهجري</div>
    </td>
  </tr>
</table>
