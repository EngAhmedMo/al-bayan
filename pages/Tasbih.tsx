...
const BASE_ADHKAR_ITEMS: TasbihItem[] = [
  ...
  { 
    id: "std_new_3", 
    label: "لَا إِلَهَ إِلَّا اللَّهُ وَاللَّهُ أَكْبَرُ، لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ، لَا إِلَهَ إِلَّا اللَّهُ لَا شَرِيكَ لَهُ، لَا إِلَهَ إِلَّا اللَّهُ لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ، لَا إِلَهَ إِلَّا اللَّهُ وَلَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللَّهِ", 
    count: 0, 
    target: 5, 
    virtue: "من قالهنَّ في يومٍ أو ليلةٍ أو شهرٍ ثم مات في ذلك اليوم أو الليلة أو الشهر غُفِرَ له ذنبه.",
    hadithSource: "عَنْ أَبِي هُرَيْرَةَ رَضِيَ اللَّهُ عَنْهُ، أَنَّ رَسُولَ اللَّهِ صَلَّى اللَّهُ عَلَيْهِ وَسَلَّمَ قَالَ: «مَنْ قَالَ: لَا إِلَهَ إِلَّا اللَّهُ وَاللَّهُ أَكْبَرُ، لَا إِلَهَ إِلَّا اللَّهُ وَحْدَهُ، لَا إِلَهَ إِلَّا اللَّهُ لَا شَرِيكَ لَهُ، لَا إِلَهَ إِلَّا اللَّهُ لَهُ الْمُلْكُ وَلَهُ الْحَمْدُ، لَا إِلَهَ إِلَّا اللَّهُ وَلَا حَوْلَ وَلَا قُوَّةَ إِلَّا بِاللَّهِ؛ يَعْقِدُهُنَّ خَمْسًا بِأَصَابِعِهِ ثُمَّ قَالَ: مَنْ قَالَهُنَّ فِي يَوْمٍ أَوْ فِي لَيْلَةٍ أَوْ فِي شَهْرٍ، ثُمَّ مَاتَ فِي ذَلِكَ الْيَوْمِ أَوْ فِي تِلْكَ اللَّيْلَةِ أَوْ فِي ذَلِكَ الشَّهْرِ، غُفِرَ لَهُ ذَنْبُهُ»\n(أخرجه النسائي في السنن الكبرى، وصححه الألباني لغيره في صحيح الترغيب والترهيب برقم 3481)" 
  }
];
      ...
      >
        ...
        <div className="min-h-full flex flex-col justify-between items-center pb-24 relative z-10">
          ...
          <div className="w-full px-4 sm:px-8 pb-6 z-10 mt-auto">
            <div className="bg-white/95 dark:bg-navy-800/95 backdrop-blur-xl rounded-3xl p-3 sm:p-4 flex items-center justify-center gap-3 shadow-2xl shadow-gold-500/10 dark:shadow-navy-950/50 border border-white/80 dark:border-navy-700">
              ...
              <div className="flex gap-2 sm:gap-3">
                {[33, 100, 1000, 0].map(val => (
                  <button
                    ...
                    className={`w-14 sm:w-16 py-2.5 sm:py-3 rounded-xl text-xs sm:text-sm font-bold transition-all active:scale-95 ${
                      target === val
              ...
              {/* Divider */}
              <div className="h-10 w-px bg-navy-100 dark:bg-navy-700 mx-1" />

              {/* Reset Button */}
              <button
                onClick={() => setIsResetOpen(true)}
                className="flex items-center gap-2 px-3 sm:px-4 h-11 sm:h-12 rounded-2xl text-[#C6AD73] border border-[#C6AD73]/30 dark:border-[#C6AD73]/60 hover:border-red-500/50 hover:text-red-500 hover:bg-red-50 dark:hover:bg-red-900/20 transition-all active:scale-95 shadow-sm"
                title="تصفير العداد"
              >
                <RotateCcw size={18} />
                <span className="hidden sm:block text-[11px] font-bold">تصفير</span>
              </button>
            </div>
